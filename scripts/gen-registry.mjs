...
for (const f of files) {
  ...
  // tier: province (kind flag) > neighbourhood (no relation id) > Bangkok district
  let tier, zone;
  if (d.kind === "province") { tier = "province"; zone = PROVINCE_REGION[d.districtTh] || "พื้นที่อื่น"; }
...
const TIER_RANK = { neighborhood: 0, district: 1, province: 2 };
metas.sort((a, b) => {
