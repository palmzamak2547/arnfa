...
export const resources = {
  th: {
    translation: {
      ...
      "hero.title2": "— ไปไหนดี?",
      "hero.sub": "Decision engine ที่อ่านฟ้าให้คุณ. วางแผนทริปกรุงเทพให้ลงล็อกกับอากาศ ณ เวลาที่จะไปถึง — ฝนมาเมื่อไหร่ Arnfa บอกที่ดีกว่าให้เอง.",
  ...
  en: {
    translation: {
      ...
      "hero.sub": "A decision engine that reads the sky for you. Plan a Bangkok day that fits the weather at the moment you arrive — when rain comes, Arnfa names a better place.",
